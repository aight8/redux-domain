...
declare module 'redux-domain/api-request-pool/errors/request-error-type' {
	 type RequestErrorType = 'TIMEOUT_ERROR' | 'CONNECTION_ERROR' | 'NETWORK_ERROR' | 'CANCEL_ERROR' | 'INVALID_STATUS' | 'INVALID_RESPONSE_TYPE' | 'INVALID_JSON_STRUCTURE' | 'EXPRESS_PROXY_ERROR' | 'API_ERROR' | 'API_FATAL_ERROR';
	export default RequestErrorType;

}
declare module 'redux-domain/api-request-pool/errors/request-error' {
	import RequestErrorType from 'redux-domain/api-request-pool/errors/request-error-type';
...
declare module 'redux-domain/api-request-pool/errors/wrapped-error' {
...
declare module 'redux-domain/api-request-pool/errors/api-error' {
	import RequestError from 'redux-domain/api-request-pool/errors/request-error';
...
declare module 'redux-domain/api-request-pool/errors/express-js-proxy-error' {
...
declare module 'redux-domain/api-request-pool/errors/timeout-error' {
...
declare module 'redux-domain/api-request-pool/errors/connection-error' {
...
declare module 'redux-domain/api-request-pool/errors/server-status-error' {
...
declare module 'redux-domain/api-request-pool/errors/network-error' {
...
declare module 'redux-domain/api-request-pool/models/api-response' {
...
declare module 'redux-domain/api-request-pool/api-request-pool' {
	import RequestError from 'redux-domain/api-request-pool/errors/request-error';
	...
	export default class ApiRequestPool {
	    protected options: ApiRequestPoolOptions;
	    private axios;
	    private cancelTokens;
	    constructor(options?: ApiRequestPoolOptions);
	    private throwError(requestError);
	    private throwNewError(type, innerError?, response?);
	    request(method: METHOD, url: string, rawData?: any, options?: ApiRequestOptions): Promise<any>;
...
declare module 'redux-domain/index' {
	...
	import ApiRequestPool from 'redux-domain/api-request-pool/api-request-pool';
